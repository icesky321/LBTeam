    ...
    protected void btUserNext_Click(object sender, EventArgs e)
    {
        ...
        if (this.FileUpload1.HasFile)
        {
            ...
            if (files == true)
            {
                ...
                {
                    this.Label1.Text = "身份证文件上传不成功";
                }
            }
            else
            {
                this.Label1.Text = "只能够上传后缀为.gif、 .jpg、 .bmp、.png的身份证文件";
            }
        }
        else
        {
            this.Label1.Text = "上传身份证文件不能为空";
        }
        if (this.FileUpload2.HasFile)
        {
            ...
            if (files == true)
            {
                try
                {
                    ...
                    this.Label2.Text = "营业执照文件上传成功,等待后台审核";
                }
                catch
                {
                    this.Label2.Text = "营业执照文件上传不成功";
                }
            }
            else
            {
                this.Label2.Text = "只能够上传后缀为.gif、 .jpg、 .bmp、.png的营业执照文件";
            }
        }
        else
        {
            this.Label2.Text = "上传营业执照文件不能为空";
        }
