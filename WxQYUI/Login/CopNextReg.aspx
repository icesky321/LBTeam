    ...
    <form id="form1" runat="server" data-ajax="false">
        <div id="pageMain" data-role="page">
            ...
            <div data-role="main" class="ui-content">
                ...
                <div style="border-bottom: 1px solid #999999; height: 2px; margin: 20px 0 20px 0;"></div>
                <div style="border-bottom: 1px solid #999999; height: 2px; margin: 20px 0 20px 0;"></div>
                <asp:TextBox ID="tbBankRen" runat="server" placeholder="收款人" ValidationGroup="Reg1" Visible="false"></asp:TextBox>
                ...
                <br />
                <asp:TextBox ID="tbBankInfo" runat="server" placeholder="收款账户开户行信息" ValidationGroup="Reg1" Visible="false"></asp:TextBox>
                ...
                <br />
                <asp:TextBox ID="tbAccount" runat="server" placeholder="收款账户银行账号" ValidationGroup="Reg1" Visible="false"></asp:TextBox>
                ...
                <div class="weui-msg">
                    ...
                    <div class="weui-msg__opr-area">
                        <p class="weui-btn-area">
                            <a href="../UserCenter/uc_cfdw.aspx" class="weui-btn weui-btn_primary" rel="external">前往我的个人中心</a>
                        </p>
                    </div>
                    <div class="weui-msg__extra-area">
                        <div class="weui-footer">
