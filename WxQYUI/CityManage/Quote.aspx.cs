...
public partial class CityManage_Quote : System.Web.UI.Page
{
    ...
    LB.BLL.CityManager_Config bll_cityManager = new LB.BLL.CityManager_Config();
    ...
    private void Load_UserInfo()
    {
        ...
        MCityManager_Config = bll_cityManager.GetCityManager_ConfigBymobileNum(mobile);
        hfUserId.Value = MCityManager_Config.UserId.ToString();

        Cobe.CnRegion.SQLServerDAL.Region region = bll_region.GetRegion(MCityManager_Config.RegionCode);
        if (region == null)
            return;
