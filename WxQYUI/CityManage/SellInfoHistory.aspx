...
<body>
    <form id="form1" runat="server" data-ajax="false">
        ...
        <asp:HiddenField ID="hfCityManagerRegionCode" runat="server" />
        <div id="page1" data-role="page">
            <div data-role="header">
                <h2>派单管理</h2>
                <div data-role="navbar">
                    <ul>
                        <li><a href="#" class="ui-btn-active">待确认订单（<asp:Literal ID="Literal3" runat="server" Text='<%# DataBinder.GetPropertyValue(hfCountDoing,"Value").ToString() %>'></asp:Literal>）</a></li>
                        <li><a href="#page2">历史订单（<asp:Literal ID="Literal2" runat="server" Text='<%# DataBinder.GetPropertyValue(hfCountDoing,"Value").ToString() %>'></asp:Literal>）</a></li>
                    </ul>
                </div>
            </div>
            <div data-role="main" class="ui-content">
                <p style="font-size: 0.8em; color: darkgrey;">产废单位有废电瓶出售意愿，向平台发起出售信息，请指派该出售信息给相应的回收业务员。</p>
                <asp:Repeater ID="rptSellInfoes_Wait" runat="server" OnItemDataBound="Repeater1_ItemDataBound" OnItemCommand="rptSellInfoes_Done_ItemCommand">
                    <ItemTemplate>
        ...
        <div id="page2" data-role="page">
            <div data-role="header">
                ...
                <div data-role="navbar">
                    <ul>
                        <li><a href="#page1" class="ui-btn-active">待确认订单（<asp:Literal ID="ltlCountProcessing1" runat="server" Text='<%# DataBinder.GetPropertyValue(hfCountDoing,"Value").ToString() %>'></asp:Literal>）</a></li>
            ...
            <div data-role="main" class="ui-content">
                <asp:Repeater ID="rptSellInfoes_Done" runat="server" OnItemDataBound="rptSellInfoes_Done_ItemDataBound" OnItemCommand="rptSellInfoes_Done_ItemCommand">
                    <ItemTemplate>
                        <div data-role="collapsible" data-collapsed="false">
                            <h3>
                                <asp:Literal ID="ltlTitle" runat="server" Text='<%# Eval("Title") %>'></asp:Literal><span style="float: right;">
