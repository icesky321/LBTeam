    ...
    <form id="form1" runat="server" data-ajax="false">
        ...
        <div id="page1" data-role="page">
            <div data-role="header">
                ...
                <div data-role="navbar">
                    <ul>
                        <li><a href="#" class="ui-btn-active">已接收订单（<asp:Literal ID="ltlCountTodo1" runat="server" Text='<%# DataBinder.Eval(hfCountDoing,"Value").ToString() %>'></asp:Literal>）</a></li>
                        <li><a href="#page2">已结束订单（<asp:Literal ID="ltlCountProcessing1" runat="server" Text='<%# DataBinder.GetPropertyValue(hfCountDone,"Value").ToString() %>'></asp:Literal>）</a></li>
                    </ul>
                </div>
            </div>
            <div data-role="main" class="ui-content">
                <p style="font-size: 0.8em; color: darkgrey;">产废单位有废电瓶出售意愿，向平台发起出售信息，请指派该出售信息给相应的回收业务员。</p>
                <asp:Repeater ID="rptSellInfoes_Doing" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                    <ItemTemplate>
                        <div data-role="collapsible" data-collapsed="false">
                            ...
                            <fieldset data-role="controlgroup" data-type="horizontal" data-inline="false">
                                <asp:Button ID="btnAccept" runat="server" Text="指派业务员" data-icon="check" CommandName="Confirm" CommandArgument='<%#Eval("InfoId") %>' rel="external" data-mini="true" data-inline="true" Visible="false" />
                            </fieldset>
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
        ...
        <div id="page2" data-role="page">
            <div data-role="header">
                ...
                <div data-role="navbar">
                    <ul>
                        <li><a href="#page1">已接收订单（<asp:Literal ID="ltlCountTodo2" runat="server" Text='<%# DataBinder.GetPropertyValue(hfCountDoing,"Value") %>'></asp:Literal>）</a></li>
                        <li><a href="#" class="ui-btn-active">已结束订单（<asp:Literal ID="ltlCountProcessing2" runat="server" Text='<%# DataBinder.GetPropertyValue(hfCountDone,"Value") %>'></asp:Literal>）</a></li>
                    </ul>
                </div>
            </div>
            <div data-role="main" class="ui-content">
