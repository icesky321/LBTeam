<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicTodayQuotation.aspx.cs" Inherits="MP_PublicTodayQuotation" %>
        ...
        <div class="page">
            <div class="page__hd">
                <div style="border: 1px dotted #999999; padding: 20px; margin: 10px 5px 0 5px;" class="ui-corner-all">
                    报价区域：<asp:Literal ID="ltlRegionWholeName" runat="server" Visible="false"></asp:Literal>
                ...
                <asp:DropDownList ID="ddlCity" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCity_SelectedIndexChanged">
                    ...
                    <asp:ListItem Value="330100000000">杭州市</asp:ListItem>
                    <asp:ListItem Value="330600000000">绍兴市</asp:ListItem>
                </asp:DropDownList>
                    <asp:Label ID="lbMsg" runat="server" ForeColor="Red"></asp:Label>
                    选择县市：
            <asp:DropDownList ID="ddlCounty" runat="server"></asp:DropDownList>
                    <asp:Button ID="btSearch" runat="server" Text="查询价格" OnClick="btSearch_Click" />
                </div>
            </div>
            <div class="page__bd">
