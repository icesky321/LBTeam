    ...
    <form id="form1" runat="server">
        <div id="page1" data-role="page">
            ...
            <div class="ui-field-contain">
                ...
                <asp:TextBox ID="tbcfdw" runat="server" Text="13777215858" Enabled="false"></asp:TextBox>
                <label for="fullname">买方：</label>
                <asp:TextBox ID="tbjdywy" runat="server" Text="15267863162" Enabled="false"></asp:TextBox>
            </div>
