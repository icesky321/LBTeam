<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="News, App_Web_vk1i312r" theme="Default" %>
                        ...
                        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                            ...
                            <asp:View ID="View2" runat="server">
                                ...
                                <asp:GridView ID="gvPrice" runat="server" DataKeyNames="id" AutoGenerateColumns="False"
                                    Width="100%" SkinID="GridView4"
                                    OnPageIndexChanging="gvPrice_PageIndexChanging" OnRowCommand="gvNew_RowCommand" OnDataBound="gvPrice_DataBound">
                                    <Columns>
                                        <asp:TemplateField HeaderText=" " SortExpression="Title">
                                            <ItemTemplate>
