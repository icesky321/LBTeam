<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="News, App_Web_t15ji3ao" theme="Default" %>
            ...
            <div class="container">
                <div class="section--header">
                    ...
                    <asp:GridView ID="gvPrice" runat="server" DataKeyNames="id" AutoGenerateColumns="False"
                        Width="100%" SkinID="GridView4"
                        OnPageIndexChanging="gvNew_PageIndexChanging" OnRowCommand="gvNew_RowCommand" Visible="false">
                        <Columns>
                            <asp:TemplateField HeaderText=" " SortExpression="Title">
                                <ItemTemplate>
