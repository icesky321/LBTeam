<%@ Page Title="" Language="C#" MasterPageFile="~/Manage.master" AutoEventWireup="true" CodeFile="MetalFactoryManage.aspx.cs" Inherits="Admin_MetalFactoryManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="gvCopInfo" runat="server" AutoGenerateColumns="false" DataKeyNames="CopId" OnRowCommand="gvCopInfo_RowCommand">
        <Columns>
            ...
            <asp:TemplateField HeaderText="公司地址 " SortExpression="CopId" Visible="false">
                <ItemTemplate>
