<%@ page title="" language="C#" masterpagefile="~/Manage.master" autoeventwireup="true" inherits="Admin_UserManage, App_Web_2443l3mj" theme="Default" %>
                ...
                <ItemTemplate>
                    <asp:MultiView ID="MultiView6" runat="server" ActiveViewIndex="0">
                        <asp:View ID="ICView1" runat="server">
                            <asp:ImageButton ID="imPass" runat="server" CommandArgument='<%#Eval("UserId") %>' CommandName="ICPass" ImageUrl="~/images/cha.png" Width="30px" Height="30px" ToolTip="审核通过" />
                        </asp:View>
                        <asp:View ID="ICView2" runat="server">
                            <asp:ImageButton ID="imUPass" runat="server" CommandArgument='<%#Eval("UserId") %>' CommandName="ICUPass" ImageUrl="~/images/gou.png" Width="30px" Height="30px" ToolTip="取消通过" />
                        </asp:View>
                    </asp:MultiView>
                </ItemTemplate>
            </asp:TemplateField>
