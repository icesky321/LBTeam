<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TradeleadsDetail.aspx.cs" Inherits="TradeleadsDetail" %>
                ...
                <div class="am-g">
                    <div class="am-u-md-12" style="text-align: center;">
                        <table class="am-u-sm-12" style="width: 100%">
                            ...
                            <tr>
                                <td colspan="2">联系方式：<asp:Label ID="lbMobileNum" runat="server" Text="Label"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>身份真实性认证：</td>
                                <td><asp:Label ID="IDAuthenticationLabel" runat="server" Text="Label" /></td>
                            </tr>
                            <tr>
                                <td>信用认证:</td>
                                <td><asp:Label ID="AuditLabel" runat="server" Text="Label" /></td>
                            </tr>
                            <tr>
                                <td>详细信息：</td>
                                <td colspan="2">&nbsp;</td>
