...
public partial class UserCenter_OneKeyMortgage : System.Web.UI.Page
{
    ...
    protected void btMortgage_Click(object sender, EventArgs e)
    {
        MUserInfo = bll_userinfo.GetUserInfoByTelNum(HttpContext.Current.User.Identity.Name);
        MUserNoticeInfo.UserId = MUserInfo.UserId;
        MUserNoticeInfo.UserNotice = "我有货想质押，请及时与我联系，联系人：" + MUserInfo.UserName + "联系方式：" + MUserInfo.MobilePhoneNum + "地址：" + MUserInfo.Province + MUserInfo.City + MUserInfo.Town + MUserInfo.Street;
