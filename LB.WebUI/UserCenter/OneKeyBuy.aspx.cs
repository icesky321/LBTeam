...
public partial class UserCenter_OneKeyBuy : System.Web.UI.Page
{
    ...
    protected void btBuy_Click(object sender, EventArgs e)
    {
        ...
        MUserNoticeInfo.UserNotice = "我想收货，请及时与我联系，联系人：" + MUserInfo.UserName + "联系方式：" + MUserInfo.MobilePhoneNum+"地址："+ MUserInfo.Province+MUserInfo.City+MUserInfo.Town+MUserInfo.Street;
