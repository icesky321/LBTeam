            ...
            if (p.Start())       //开始进程
            {
                if (milliseconds == 0)
                {
                   ...
                   p.StandardInput.WriteLine(@"cd C:\Program Files (x86)\Microsoft SDKs\Windows\v10.0A\bin\NETFX 4.6.1 Tools\");
                    ...
                    p.StandardInput.WriteLine(@"sqlmetal.exe /conn:""data source=127.0.0.1;Initial Catalog=LvBao;User ID=sa;password=LHGMnt1982!@ "" /language:C# /namespace:LB.SQLServerDAL /context:LBDataContext /views /dbml:""E:\Develop\LvBao\LBTeam.New\LB.SQLServerDAL\LBDB.dbml""");
